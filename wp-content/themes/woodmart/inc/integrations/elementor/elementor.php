...
if ( ! function_exists( 'woodmart_elementor_enqueue_editor_styles' ) ) {
	...
	add_action( 'elementor/controls/controls_registered', 'woodmart_elementor_enqueue_editor_styles' );
}
...
if ( ! function_exists( 'woodmart_add_elementor_widget_categories' ) ) {
	 ...
	 */
	function woodmart_add_elementor_widget_categories( $elements_manager ) {
	...
	add_action( 'elementor/elements/categories_registered', 'woodmart_add_elementor_widget_categories' );
}
